...
wire [6:0] SS [3:0];
BCD_Decoder BCD_Decoder0 (BCD0, SS[0]);     //mins1
BCD_Decoder BCD_Decoder1 (BCD1, SS[1]);     //mins2
BCD_Decoder BCD_Decoder2 (BCD2, SS[2]);     //hours1
BCD_Decoder BCD_Decoder3 (BCD3, SS[3]);     //hours2
...
always @(*) begin // This describes a purely combinational circuit
    ...
    else if(PWM) begin // if need to turn the seven segment on or not. if (pwm_out)
